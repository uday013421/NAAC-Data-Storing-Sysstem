...
?>
<?php
 $result = mysqli_query( $conn,"SELECT * FROM stu ORDER by id DESC");
...
<body>
    ...
    <div class="nav1">
        ...
        <a href="http://localhost/Reg_page/student%20achi.php">Student</a>
            <div class="nav2">
                ...
                <div class="search">
                    <input type="search" id="03" placeholder="Search">
                </div>
    ...
    <div class="con">
        ...
        <table bgcolor="black" width="100%">
            ...
            // echo '<td>'.$res['id'].'</td>';
            echo'<td>'.$res['Name'].'</td>';
            echo'<td>'.$res['Department'].'</td>';            //   <td> </td>
