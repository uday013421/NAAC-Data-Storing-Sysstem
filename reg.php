...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $exists=false;
    if( $exists==false){
           $sql = "INSERT INTO `admin` (`Email`, `Name`, `Depart`, `Ename`, `Elevel`, `Eloc`, `EDate`, `Rank`,`certificate`, `desp`) VALUES ('$Email', '$Name', '$Dep', '$Ename', '$Depart', '$pran', '$Devent', '$Rank',' $file', '$Desp')";
...
<body>
    ...
    <div class="con">
        <h1>FACULTY ACHIEVEMENTS FORM</h1>
      ...
      <div class="lable">
       ...
       <!-- <input type="text" style="width: 100px;"> -->
        ...
        <div class="sub" style="margin-top: 100px; margin-left: 45%; ">
            <button type="submit" name="btn" id="btn" style="width: 100px; height: 50px; font-size: medium; font-family: Arial, Helvetica, sans-serif;color: aliceblue;background-color: #00B4D8; border-radius: 10px;"><a href="http://127.0.0.1:5501/admin%20(1).html" style="Text-Decoration:none;color:white;">Upload</a></button>
          </div>
    </form>
      </div>
